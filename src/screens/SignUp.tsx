  ...
  const onSubmit: SubmitHandler<SignUpFormValues> = (data) => {
    ...
    try {
      if (!checked) {
        setError("password", {
          type: "custom",
          message: "Please confirm if you accept our terms of usage",
        });
      ...
      <ScrollView>
        <Box marginTop="space-96">
          <Box style={styles.header}>
            <Text color="black" variant="heading-1">
              Register Account
            </Text>
          ...
          <Box flexDirection="row" alignItems="center">
            ...
            <Text variant="caption-medium" style={{ alignSelf: "center" }}>
          ...
          <Box marginTop="space-40" flexDirection="row" justifyContent="center">
